...
// The ProbeTokenFunc type is an adapter to allow the use of ordinary
// function as ProbeToken mutator.
type ProbeTokenFunc func(context.Context, *ent.ProbeTokenMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProbeTokenFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProbeTokenMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProbeTokenMutation", m)
}

// The RecipientKeyFunc type is an adapter to allow the use of ordinary
// function as RecipientKey mutator.
type RecipientKeyFunc func(context.Context, *ent.RecipientKeyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RecipientKeyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RecipientKeyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RecipientKeyMutation", m)
}
...
// The TOTPSecretFunc type is an adapter to allow the use of ordinary
// function as TOTPSecret mutator.
type TOTPSecretFunc func(context.Context, *ent.TOTPSecretMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TOTPSecretFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TOTPSecretMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TOTPSecretMutation", m)
}
